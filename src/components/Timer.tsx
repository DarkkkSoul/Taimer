...
export const Timer: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-black/20 backdrop-blur-xl border border-white/10 rounded-3xl p-8 max-w-md w-full shadow-2xl">
        {/* Header */}
        ...
        <div className="text-center mb-12">
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-indigo-400 blur-2xl opacity-30 rounded-2xl"></div>
            <div className="relative bg-black/30 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              <div className="text-5xl md:text-6xl font-mono font-bold text-transparent bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text">
        ...
        <div className="flex justify-center items-center space-x-4 mb-8">
          ...
          {!isRunning ? (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </button>
          ) : (
            <button
              onClick={pause}
          ...
          <button
            ...
            className={`group relative flex items-center justify-center w-16 h-16 rounded-full transition-all duration-300 transform focus:outline-none ${
              elapsedTime === 0
                ...
                : 'bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-400 hover:to-pink-400 hover:scale-105 focus:ring-4 focus:ring-red-500/30 shadow-lg shadow-red-500/25'
            }`}
          >
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-12 h-1 bg-gradient-to-r from-purple-400 to-indigo-400 rounded-full opacity-50"></div>
        </div>
      </div>
    </div>
  );
